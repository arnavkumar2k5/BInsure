...
function Component4() {
  return (
    <div className="bg-white flex flex-col justify-center items-center px-6 pt-20 md:pt-36 gap-5 pb-20">
        <div>
      ...
      <div className="text-gray-600 mb-12 max-w-[35rem] text-sm text-center">
        ...
        <div className='flex flex-col md:flex-row justify-center gap-5 text-sm mt-20 m-5'>
                <div className='flex flex-col bg-white p-10 shadow-lg rounded-md md:w-1/4 gap-5 pb-28 border-2 border-[#E0E0E0]'>
                ...
                <div className='flex flex-col bg-white p-10 shadow-lg rounded-md md:w-1/4 gap-5 border-2 border-[#E0E0E0]'>
      ...
      <div>
        <button className="text-[1rem] font-bold">
