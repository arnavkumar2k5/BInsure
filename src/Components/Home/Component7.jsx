...
function Component7() {
  return (
    <div className="flex flex-col md:flex-row justify-center pt-20 px-8 gap-20 pb-20">
      ...
      <div className="md:w-[48%] bg-white shadow-xl rounded-2xl p-10 pb-10">
        ...
        <div className="bg-gray-300 h-px mt-28 mb-5"></div>
