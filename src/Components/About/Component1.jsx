...
function Component1() {
    return (
        <div className='bg-[#E5F9FF] flex flex-col justify-center items-center md:h-[100vh] pt-20'>
            ...
            <div className='text-xs md:text-[1rem]'>WHO WE ARE</div>
            <div className='text-2xl md:text-[2rem] font-bold'>We’re  – an online <p className='block md:inline'>Canadian insurer</p></div>
            <div className='text-base pl-10 pr-10'>
                <p className='inline md:block'>As Canada’s own online insurance solution company, we’re changing insurance for</p>
                <p className='inline md:block'>the better. By using data and analytics, we’re able to offer customized coverage at a</p>
                <p className='inline md:block'>competitive price in language you can understand, and all in as little as 5 minutes.</p>
            </div>
            </div>
