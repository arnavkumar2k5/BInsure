...
function Component4() {
    return (
        <div className="bg-white flex flex-col justify-center items-center py-10 mx-auto gap-20 md:p-20 p-5 md:px-40">
          ...
          <div className="flex flex-col sm:flex-row sm:flex-wrap text-sm md:text-base gap-10 justify-center">
            ...
            <div className='bg-[#24BBE3] p-3 text-white font-semibold rounded-lg'>Insure your restaurant now!</div>
        </div>
    )
}
