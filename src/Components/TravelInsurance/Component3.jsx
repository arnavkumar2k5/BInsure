...
function Component3() {
  ...
  return (
    <div className="flex flex-col md:flex-row justify-center items-center p-5 md:pt-40 m-auto md:pb-40 md:p-40 bg-white">
      <div className="p-3 md:w-[40%]">
        ...
        <div className="bg-[#24BBE3] text-white font-semibold text-sm p-3 inline-block rounded-lg mt-8 ml-28 md:ml-0">
            Get a Quote
        </div>
      </div>
