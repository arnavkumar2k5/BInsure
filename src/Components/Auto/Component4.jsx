    ...
    return (
        <div className="bg-white flex flex-col justify-center items-center py-10 mx-auto gap-20 md:p-20 p-5">
          <div className="text-lg text-center">
            <div className="text-3xl font-bold">Auto Insurance Examples</div>
            <p className="text-lg max-w-[47rem] mx-auto mt-5 font-normal text-[#073141]">
          ...
          <div className="flex flex-col sm:flex-row sm:flex-wrap text-sm md:text-base gap-10 justify-center md:px-20">
            <div className=" rounded-sm p-5 text-start flex flex-col w-full sm:w-[30%]">
            ...
            <div className='bg-[#24BBE3] font-semibold p-3 text-white rounded-lg'>Insure now</div>
        </div>
    )
}
