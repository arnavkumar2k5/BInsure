...
function Component1() {
  ...
  return (
    <div className="flex flex-col justify-center items-center relative h-screen">
      ...
      <div className="m-5 md:m-0 md:w-[60%] relative">
      <div className="w-full z-30 h-[70vh] md:h-[53vh] md:p-10 shadow-xl p-5 rounded-2xl relative bg-white flex flex-col items-center gap-5 md:gap-10">
        ...
        <div className="p-2 md:p-3 border-2 border-gray-300 inline font-bold cursor-pointer w-2/3 md:w-1/3 text-center rounded-full text-sm text-cyan-400">
          GET A FREE QUOTE
        </div>
