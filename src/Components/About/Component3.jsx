...
function Component3() {
  return (
    <div className="bg-white flex flex-col justify-center items-center px-6 md:px-40 pt-20 md:pt-36">
        <div className="flex justify-between w-full items-center md:pl-16">
            <div>
      <div className="text-xl mb-3 md:text-4xl font-semibold">
      ...
      <div className="grid md:grid-cols-3 gap-16 text-start mb-12 md:gap-x-40">
        <div className="flex flex-col gap-2">
          <p className="text-lg md:text-2xl font-semibold">Solving problems</p>
          <p className="text-sm text-gray-600 font-medium">We’re solving problems that change 
          <p>and save lives.</p></p>
        </div>
        <div className="flex flex-col gap-2">
          <p className="text-lg md:text-2xl font-semibold">Powered by people.</p>
        ...
        <div className="flex flex-col gap-2">
          <p className="text-lg md:text-2xl font-semibold">Make it right.</p>
        ...
        <div className="flex flex-col gap-2">
          <p className="text-lg md:text-2xl font-semibold">Seek the truth.</p>
          <p className="text-sm text-gray-600 font-medium">… but never assume you’ve found it. <p>Be scientific.</p></p>
        </div>
        <div className="flex flex-col gap-2">
          <p className="text-lg md:text-2xl font-semibold">Inspire & provoke.</p>
          <p className="text-sm text-gray-600 font-medium">
          Develop and display leadership at <p className="inline md:block">all levels.</p>
          </p>
        </div>
        <div className="flex flex-col gap-2">
          <p className="text-lg md:text-2xl font-semibold">Be transparent.</p>
          <p className="text-sm text-gray-600 font-medium">
