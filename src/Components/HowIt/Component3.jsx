    ...
    return (
        <div className='bg-[#FCFCFC] pb-20 pt-10'>
            <div className='flex flex-col justify-center items-center text-center mt-20 gap-5'>
                ...
                <p>HOW IT WORKS</p>
                <div className='text-xl md:text-3xl font-bold'>How  saves your time and money</div>
                </div>
                <div className='font-base text-sm p-3'>
            ...
            <div className='mt-28 md:pr-56 md:pl-56'>
                <div className='flex flex-col-reverse md:flex-row justify-between items-center'>
                    <div className='md:w-1/2 p-5 md:p-0'>
                        <p className='text-3xl font-bold mb-3'>Compare</p>
                ...
                <div className='flex flex-col md:flex-row justify-between items-center mt-10'>
                    ...
                    <div className='md:w-1/2 p-5'>
                        <p className='text-3xl font-bold mb-3'>Purchase</p>
                ...
                <div className='flex flex-col-reverse md:flex-row justify-between items-center mt-10'>
                    <div className='md:w-1/2 p-5'>
                        <p className='text-3xl font-bold mb-3'>Manage</p>
