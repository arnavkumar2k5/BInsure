  ...
  return (
    <div className="bg-white p-8">
      ...
      <div className="flex flex-col md:flex-row justify-center gap-5">
        <div className="bg-gray-50 p-5 md:p-10 pt-20 shadow-sm border-2 border-[#D9D9D9] md:w-[35rem]">
        ...
        <div className="bg-gray-50 p-5 md:p-10 pt-20 shadow-sm border-2 border-[#D9D9D9] md:w-[35rem]">
          ...
          <p className="pr-20">When you need help with insurance and claims,
          ...
          <div className="space-y-4 mt-10">
            ...
            <div>
              <button
                ...
                className="w-full text-sm md:text-lg flex justify-between font-semibold text-gray-800"
              >
