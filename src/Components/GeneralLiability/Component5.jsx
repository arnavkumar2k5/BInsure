    ...
    <div className="bg-white pt-40 pb-40 md:pl-40">
      <div className="m-auto flex flex-col p-5 md:p-10">
        <div className="flex flex-col md:flex-row justify-center items-center">
          <div className="w-full md:w-[50%] flex flex-col gap-2 md:gap-10 text-[0.8rem] md:text-[0.9rem]">
            ...
            <div className="rounded-lg font-semibold bg-[#24BBE3] text-white p-3 text-center md:w-[40%] self-center md:self-start">
