...
function Component2() {
  return (
    <div className="bg-white">
      <div className="flex flex-col justify-center items-center py-10 mx-auto gap-20 m6:gap200 pt-20 md:pt-40 pb-20 md:pb-40">
        <div className="text-sm text-center">
          <div className="text-2xl md:text-4xl font-semibold">Why Choose B-Insure</div>
          <p className="text-xs md:text-sm font-normal max-w-[25rem] md:max-w-[35rem] mx-auto mt-4">
