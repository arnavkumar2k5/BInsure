    ...
    <div className="bg-white flex flex-col justify-center items-center px-2 md:px-6 pt-20 md:pt-36 gap-5 pb-20">
      ...
      <div className="m-auto justify-center flex flex-col">
        <div className="self-center m-auto">
          <img src="/about/img5.png" alt="img" className="h-80" />
        </div>
        <div className="flex flex-col md:flex-row justify-center gap-5 m-5 mt-0 text-base font-medium text-black">
          <div className="flex flex-col bg-white p-10 shadow-lg rounded-md md:w-[30%] gap-5 pb-28 border-2 border-[#E0E0E0]">
          ...
          <div className="flex flex-col bg-white p-10 shadow-lg rounded-md md:w-[30rem] gap-5 pb-28 border-2 border-[#E0E0E0]">
