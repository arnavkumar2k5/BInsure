...
function Component2() {
  return (
    <div className="bg-white w-full m-auto">
      <div className="flex flex-col justify-center items-center py-10 mx-auto p-5 md:px-40 gap-20 pt-20 md:pt-40">
        <div className="text-sm text-center">
          <div className="text-xl md:text-4xl font-semibold">Travel Insurance Coverages</div>
