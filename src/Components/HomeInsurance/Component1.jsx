...
function Component1() {
  return (
    <div className="bg-white">
      <div className="m-auto flex flex-col gap-10 md:gap-28 px-16">
        ...
        <div className="flex flex-col-reverse md:flex-row justify-center gap-10 md:gap-24 items-center">
          ...
          <div className="w-full md:w-[43%] flex flex-col gap-5 text-[0.8rem] md:text-[0.9rem]">
            ...
            <div className="rounded-lg md:mt-5 bg-[#24BBE3] text-white p-3 text-center w-[50%] md:w-[30%] self-center md:self-start">
              Get a Quote
            </div>
          </div>
        </div>
